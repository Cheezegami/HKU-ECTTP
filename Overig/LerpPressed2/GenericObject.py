...
class GenericObject(object) :
    ...
    def alterObjectPosition(self):
        if(self.bool_lerpPosition == True):
            ...
            ScoreBoard.int_score = int(lerp(self.base_score[0],self.next_score[0],self.float_lerpStep[0]))
        ...
        if(self.bool_lerpSize == True):
            ...
            ScoreBoard.int_score = int(lerp(self.base_score[1],self.next_score[1],self.float_lerpStep[1]))
