...
def setup(): # Defining parameters that run once.
    ...
    # Object Creation.
    # Width, Height, X, Y, Speed, Shape, Movestyle, Red, Green, Blue, Border.
    ...
    objectList.append(GenericObject(100,100,int_border+random(width-int_border),int_border+random(height-int_border),10,"rectangle",1,127,60,255,int_border)) # Third, Movable Object
