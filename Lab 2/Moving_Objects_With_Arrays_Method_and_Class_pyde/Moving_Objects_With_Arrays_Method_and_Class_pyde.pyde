...
objectList.append(GenericObject(50,50,int_border+250,int_border,int_border,5,False,False,"rectangle")) # First Object
objectList.append(GenericObject(100,100,int_border,int_border+250,int_border,10,False,False,"ellipse")) # Second Object
                        
def setup(): # Defining parameters that run once.
    size(1000,700) # Screen size. (Width,Height)
