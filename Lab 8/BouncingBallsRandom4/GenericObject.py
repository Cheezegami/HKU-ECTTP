...
class GenericObject(object) :
    ...
    def __init__(self,int_oWidth,int_oHeight,int_oX,int_oY,int_oSpeed,String_form,int_movestyle,color_red,color_green,color_blue,int_border) : # Constructor
        ...
        self.int_colorLow = 40+ random(40)
        self.int_colorMedium = 63 + random(64)
        self.int_colorHigh = 127 + random(128)
    ...
    def checkCollision(self, other): # Method for checking collision with other objects.
        if(self.int_oX + self.int_oWidth > other.int_oX and self.int_oX < other.int_oX + other.int_oWidth and self.int_oY + self.int_oHeight > other.int_oY and self.int_oY < other.int_oY + other.int_oHeight):
            ...
            ScoreBoard.int_score = ScoreBoard.int_score + 1
